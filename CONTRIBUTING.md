# Contributing to ukraineadvocacy

Thank you for your interest in contributing to ukraineadvocacy! This document provides guidelines and instructions for contributing to this project.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/ukraineadvocacy.git
   cd ukraineadvocacy
   ```
3. **Add the upstream remote**:
   ```bash
   git remote add upstream https://github.com/igor-kan/ukraineadvocacy.git
   ```
...
By contributing to ukraineadvocacy, you agree that your contributions will be licensed under the project's [MIT License](LICENSE).
